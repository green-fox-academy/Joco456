...
void draw()
{
    ...
    SDL_RenderDrawLine(gRenderer, SCREEN_WIDTH/8, SCREEN_HEIGHT/8, SCREEN_WIDTH/8*7, SCREEN_HEIGHT/8);

    SDL_SetRenderDrawColor(gRenderer, 0x00 /*R*/, 0xFF /*G*/, 0x00 /*B*/, 0xFF /*A*/);
    SDL_RenderDrawLine(gRenderer,SCREEN_WIDTH/8 , SCREEN_HEIGHT/8, SCREEN_WIDTH/8, SCREEN_HEIGHT/8*7);

    SDL_SetRenderDrawColor(gRenderer, 0x00 /*R*/, 0x00 /*G*/, 0xFF /*B*/, 0xFF /*A*/);
    SDL_RenderDrawLine(gRenderer, SCREEN_WIDTH/8, SCREEN_HEIGHT/8*7, SCREEN_WIDTH/8*7, SCREEN_HEIGHT/8*7);

    SDL_SetRenderDrawColor(gRenderer, 0xFF /*R*/, 0x00 /*G*/, 0xFF /*B*/, 0xFF /*A*/);
    SDL_RenderDrawLine(gRenderer,SCREEN_WIDTH/8*7 , SCREEN_HEIGHT/8, SCREEN_WIDTH/8*7, SCREEN_HEIGHT/8*7);
